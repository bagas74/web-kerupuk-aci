...
function shopData() {
  return {
    ...
    products: [
      {
        name: "Krupuk Aci Original",
        desc: "Renyah gurih dengan bumbu bawang asli.",
        detail:
          "Resep warisan sejak 1990. Rasa bawangnya kuat namun tidak bikin eneg.",
        price: "Rp 15.000",
        weight: "250 Gram",
      ...
      },
      {
        ...
        detail:
          "Khusus pecinta pedas! Cabai rawit merah asli yang dikeringkan.",
        price: "Rp 18.000",
        weight: "200 Gram",
      ...
      },
      {
        ...
        detail: "Krupuk digoreng bantat diaduk bumbu kencur & daun jeruk.",
        price: "Rp 20.000",
        weight: "150 Gram",
